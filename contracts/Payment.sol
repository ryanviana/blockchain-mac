...
contract PaymentContract is Ownable, ReentrancyGuard {
    IAdvertisement private advertisementContract;
    struct Payment {
        uint256 amount;
        address recipient;
    ...
    function pay(uint256 _paymentId) public {
        ...
        // require(
        //     advertisementContract.isCampaignFunded(_advertisementId),
    ...
    function refundUnusedFunds(uint256 advertisementId) public {
        IAdvertisement.Advertisement memory currentAdvertisement = advertisementContract
    ...
    function resetAmountToBePaid(uint256 _advertisementId) public view onlyOwner {
        IAdvertisement.Advertisement memory currentAdvertisement = advertisementContract
            .getAdvertisement(_advertisementId);

        currentAdvertisement.amountToBePaid = 0;
    }
}