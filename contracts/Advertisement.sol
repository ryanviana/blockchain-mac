...
contract AdvertisementContract is Ownable {
    ...
    function createAdvertisement(
        ...
        uint256 newAdvertisementId = nextAdvertisementId; // Store the current nextAdvertisementId
        ...
        advertisements[newAdvertisementId] = newAdvertisement;
        ...
        nextAdvertisementId++; // Increment the ID for the next Advertisement

        return newAdvertisementId; // Return the new Advertisement ID
    }
